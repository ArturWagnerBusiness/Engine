class Village extends Phaser.Scene{
    ...
    middle: Phaser.Tilemaps.StaticTilemapLayer;
    above: Phaser.Tilemaps.StaticTilemapLayer;
    tileset_objects: Phaser.Types.Tilemaps.TiledObject[];
    object_manager: Object_manager;
    bgmusic: Phaser.Sound.BaseSound;
    last_goblin: number;
    spawn_interval: number;
    last_boss: number;
    spawn_interval_reduce_timer: number;
    ...
    create(){
        ...
        // this.object_manager.player.data.gold = 90000;
