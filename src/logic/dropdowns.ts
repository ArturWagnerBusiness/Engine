...
`+//    <div class="player-mana"><div class="fill"></div><div class="text"></div></div>
`       <div class="gold"></div>
...
`);
    ...
    update(time: any, delta: any){
        ...
        //$(".player-mana").html("MANA: "+this.object_manager.player.data.mana+"/"+this.object_manager.player.data.max_mana);
